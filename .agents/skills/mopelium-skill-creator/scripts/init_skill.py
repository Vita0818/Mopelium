#!/usr/bin/env python3
"""Create an Mopelium Agent Skill skeleton inside an explicitly selected root.

Modified by Mopelium from the OpenAI Codex skill-creator sample; see
...
def main():
    parser = argparse.ArgumentParser(
        description="Create an Mopelium Agent Skill skeleton."
    )
