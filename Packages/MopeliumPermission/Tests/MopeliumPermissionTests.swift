...
@testable import MopeliumPermission
...
final class MopeliumPermissionTests: XCTestCase {
    ...
    func testSecretScannerPaths() {
        ...
        XCTAssertTrue(SecretScanner.isSensitivePath("~/.config/mopelium/config.json"))
        ...
        XCTAssertTrue(SecretScanner.isSensitivePath("~/.local/share/intatis/auth.json"))
