...
final class PathConfinementTests: XCTestCase {
    ...
    private func tempWorkspace() throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("mopelium-path-\(UUID().uuidString)", isDirectory: true)
    ...
    func testAgentConfigSecretPathsDenied() throws {
        ...
        XCTAssertThrowsError(try PathConfinement.resolve("~/.config/mopelium/config.json", within: root))
