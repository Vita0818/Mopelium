...
public struct MopeliumDiagnosticFileSnapshot: Equatable, Sendable {
...
public enum MopeliumDiagnosticSnapshotError:
...
public enum MopeliumDiagnosticSnapshotReader {
    ...
    public static func readTail(
        ...
        guard descriptor >= 0 else {
            if errno == ELOOP {
                throw MopeliumDiagnosticSnapshotError.unsafeFile
            }
            throw MopeliumDiagnosticSnapshotError.readFailed
        }
        ...
        return MopeliumDiagnosticFileSnapshot(
            data: result,
...
public struct MopeliumDiagnosticRedactedEventLog: Equatable, Sendable {
    public let data: Data
...
public enum MopeliumDiagnosticEventLogRedactor {
    ...
    public static func redact(
        _ snapshot: MopeliumDiagnosticFileSnapshot,
        maximumOutputBytes: Int = 8 * 1_024 * 1_024
    ) -> MopeliumDiagnosticRedactedEventLog {
        let outputLimit = max(
            1_024,
        ...
        return MopeliumDiagnosticRedactedEventLog(
            data: output,
    ...
    private static func redactEnvelope(
        ...
        for key in ["ts", "session", "type"] {
            ...
            output[key] = MopeliumHangDiagnosticTextSanitizer.sanitize(
                value,
                maximumBytes: 1_024)
        }
