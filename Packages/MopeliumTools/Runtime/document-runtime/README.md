# Mopelium document runtime release contract

The document tools use external document engines; Mopelium does not implement
...
```text
Mopelium.app/Contents/Resources/DocumentRuntime/arm64
Mopelium.app/Contents/Resources/DocumentRuntime/x86_64
```
