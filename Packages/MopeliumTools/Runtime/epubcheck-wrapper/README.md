...
The wrapper accepts no Mopelium-specific command language. A release forwards
...
under `Mopelium.app/Contents/Resources/DocumentRuntime/<architecture>` fails
...
Mopelium release must preserve the distribution's `LICENSE.txt`,
