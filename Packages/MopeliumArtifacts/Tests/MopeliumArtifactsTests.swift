import XCTest
import MopeliumCore
@testable import MopeliumArtifacts

final class MopeliumArtifactsTests: XCTestCase {

    private func makeTempRoot() -> URL {
        FileManager.default.temporaryDirectory
            .appendingPathComponent("mopelium-artifacts-\(UUID().uuidString)", isDirectory: true)
    }
