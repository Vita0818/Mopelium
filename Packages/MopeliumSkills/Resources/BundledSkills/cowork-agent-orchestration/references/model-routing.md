...
Mopelium may select. It exposes only host-approved, secret-free IDs, labels, model IDs,
...
attachment/artifact to be available to that secondary; if Mopelium cannot transfer
