import XCTest
import MopeliumCore
@testable import MopeliumProtocol
...
final class WorkspaceLeaseTests: XCTestCase {
    ...
    func testWorkspaceLeaseBindsExistingDirectoryIdentityAndDetectsReplacement() throws {
        let parent = FileManager.default.temporaryDirectory
            .appendingPathComponent("mopelium-lease-identity-\(UUID().uuidString)", isDirectory: true)
    ...
    func testWorkspaceLeaseExpressesRootAccessAndDeniedPatterns() {
        ...
        for required in [
            ...
            "**/.config/gh/**", "**/.config/mopelium/**",
            "**/.config/intatis/**", "**/.git/config",
            ".mopelium-rag-store.json", ".mopelium-rag-snapshots",
            ".mopelium-rag-host", ".intatis-rag-store.json",
            ".intatis-rag-snapshots", ".intatis-rag-host",
        ] {
            XCTAssertTrue(
