...
/// Mopelium request. This type is intentionally not interchangeable with a
...
/// Host identity for a task that Mopelium owns on behalf of a server callback
/// request. Keeping this distinct prevents accidental routing into the remote
/// task state machine or the Mopelium/Cowork task graph.
