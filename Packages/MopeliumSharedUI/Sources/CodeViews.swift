...
public struct CodeShell: View {
    ...
    private func content(rawWidth: CGFloat) -> some View {
        ...
        return threadColumn(layout: MopeliumThreadContentLayout(rawWidth: threadWidth))
    ...
    private func threadColumn(layout: MopeliumThreadContentLayout) -> some View {
        VStack(spacing: 0) {
    ...
    private func header(layout: MopeliumThreadContentLayout) -> some View {
        MopeliumWorkspaceThreadHeader(
            title: sessionTitle,
            subtitle: "\(workspaceName) · \(mopeliumLocalizedAgentState(agentState))",
            style: threadStyle,
            actions: [])
...
struct CodeItemRow: View {
    ...
    private func card(icon: String, title: String, body: String, tint: Color) -> some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            if let advice = item.recoveryAdvice {
                MopeliumRecoveryAdviceView(advice: advice, tint: tint, style: style)
            }
        }
        .padding(11)
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 14) {
                ...
                inspectorSection(MopeliumLocalization.string("Recent Failures")) {
