...
public final class ChatViewModel: ObservableObject {
    ...
    @Published public private(set) var draftAttachments: [MopeliumComposerDraftAttachment] = []
    ...
    public init(
        ...
        self.composerAttachmentStore = artifactStore.map {
            MopeliumComposerAttachmentStore(store: $0)
        }
        #if canImport(AVFoundation)
        ...
        let operation = Task { @MainActor [weak self] in
            ...
            for url in urls {
                ...
                do {
                    ...
                    guard !MopeliumCancellation.isCurrentTaskCancellation(error) else {
                        return
                    }
                    self.errorText = MopeliumLocalization.format(
