...
public enum MopeliumMessageRendererMode: String, CaseIterable, Sendable {
    case microsoft
    case plainSafe

    public static let defaultsKey = "mopelium.messageRendering.mode.v1"
    public static let plainSafeLaunchArgument = "-MopeliumPlainSafeMessages"
    public static let microsoftLaunchArgument = "-MopeliumMicrosoftMarkdownMessages"
    public static let legacyRichLaunchArgument = "-MopeliumRichTextMessages"
...
public struct MopeliumMessageRenderPlan: Equatable, Sendable {
    ...
    public static func resolve(
        ...
        isComplete: Bool,
        policyIsRich: Bool,
        rendererMode: MopeliumMessageRendererMode
    ) -> Self {
