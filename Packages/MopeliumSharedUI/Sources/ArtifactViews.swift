...
struct ArtifactCardView: View {
    ...
    private var localizedKind: String {
        ...
        case "image": return MopeliumLocalization.string("image")
        case "transcript": return MopeliumLocalization.string("transcript")
    ...
    private var fileText: String {
        (try? String(contentsOfFile: artifact.path, encoding: .utf8))
            ?? MopeliumLocalization.string("(transcript)")
    }
}
#endif
