...
public struct MopeliumWorkspaceInspectorLayout: Equatable {
...
public enum MopeliumWorkspaceInspectorLayoutPolicy {
    public static func resolve(
        ...
        guard isRequested,
            ...
            return MopeliumWorkspaceInspectorLayout(
                isVisible: false,
...
public enum MopeliumCoworkStatusRailLayoutPolicy {
