...
// part of the Mopelium composer integration.
...
private enum ComposerVoiceTemporaryFiles {
    static let audioPrefix = "Mopelium-Audio-"
    private static let legacyAudioPrefix = "mopelium-voice-input-"
...
public final class ComposerVoiceInputController: ObservableObject {
    ...
    public var buttonHelp: String {
        switch phase {
        case .idle:
            return MopeliumLocalization.string("Start voice input")
        case .requestingPermission:
            return MopeliumLocalization.string("Preparing voice input")
        case .recording:
            return MopeliumLocalization.string("Stop and transcribe")
        case .transcribing:
            return MopeliumLocalization.string("Transcribing voice input")
        }
    }
    ...
    private func publish(_ error: Error) {
        ...
        default:
            errorText = MopeliumLocalization.format(
                "Voice input failed: %@",
