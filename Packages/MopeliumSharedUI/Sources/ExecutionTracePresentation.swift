...
public enum MopeliumExecutionTracePresentation {
    public static let launchArgument = "-MopeliumShowExecutionTrace"
    public static let environmentVariable = "MOPELIUM_SHOW_EXECUTION_TRACE"
