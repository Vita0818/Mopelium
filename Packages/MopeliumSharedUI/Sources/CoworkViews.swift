...
private func mopeliumNormalizedStatus(_ status: String) -> String {
    status
...
private func mopeliumLocalizedRawStatus(_ status: String) -> String {
    switch mopeliumNormalizedStatus(status) {
    case "idle": return MopeliumLocalization.string("idle")
    case "active": return MopeliumLocalization.string("active")
    case "running": return MopeliumLocalization.string("running")
    case "thinking": return MopeliumLocalization.string("thinking")
    case "tool": return MopeliumLocalization.string("tool")
    case "assigned": return MopeliumLocalization.string("assigned")
    case "paused": return MopeliumLocalization.string("paused")
    case "pending": return MopeliumLocalization.string("pending")
    case "queued": return MopeliumLocalization.string("queued")
    case "ready": return MopeliumLocalization.string("ready")
    case "mailbox": return MopeliumLocalization.string("mailbox")
    case "completed", "complete", "done":
        return MopeliumLocalization.string("completed")
    case "failed": return MopeliumLocalization.string("failed")
    case "error": return MopeliumLocalization.string("error")
    case "rejected": return MopeliumLocalization.string("rejected")
    case "blocked": return MopeliumLocalization.string("blocked")
    case "budget_limited": return MopeliumLocalization.string("budget limited")
    case "usage_limited": return MopeliumLocalization.string("usage limited")
    case "in_progress", "inprogress":
        return MopeliumLocalization.string("in progress")
    case "cancelled", "canceled":
        return MopeliumLocalization.string("cancelled")
    case "detached", "removed", "cleaned":
        return MopeliumLocalization.string("detached")
    default: return status
    }
}

private func mopeliumLocalizedDisplayStatus(_ status: String) -> String {
    switch mopeliumNormalizedStatus(status) {
    case "idle": return MopeliumLocalization.string("Idle")
    case "active": return MopeliumLocalization.string("Active")
    case "running": return MopeliumLocalization.string("Running")
    ...
    default:
        let display = status
            ...
            .capitalized
        return MopeliumLocalization.string(display)
    }
}

private func mopeliumLocalizedAgentRole(_ role: String) -> String {
    switch role.lowercased() {
    case "main": return MopeliumLocalization.string("main")
    case "coordinator": return MopeliumLocalization.string("coordinator")
    case "worker": return MopeliumLocalization.string("worker")
    case "reviewer": return MopeliumLocalization.string("reviewer")
    default: return role
    }
}
...
public struct CoworkAgentInfo: Identifiable, Equatable, Sendable {
    ...
    public var statusLine: String {
        ...
        if queued > 0 {
            return MopeliumLocalization.format(
                "%@ · %lld queued",
                mopeliumLocalizedRawStatus(status),
                Int64(queued))
        }
        if completedTasks > 0 {
            return MopeliumLocalization.format(
        ...
        return mopeliumLocalizedRawStatus(status)
    }
    ...
    public var inferenceDisplayLabel: String? {
        ...
        case .unresolved:
            return MopeliumLocalization.string("Inference unavailable")
        case .incompatible:
            return MopeliumLocalization.string("Inference incompatible")
        ...
        if !components.isEmpty {
            ...
            return inferenceResolution == .legacy
                ? MopeliumLocalization.format("Legacy · %@", label)
                : label
        }
        return inferenceResolution == .resolved
            ? MopeliumLocalization.string("Inference resolved")
            : MopeliumLocalization.string("Legacy inference")
    }
...
private enum CoworkInspectorTab: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .agents: return MopeliumLocalization.string("Agents")
        case .tasks: return MopeliumLocalization.string("Tasks")
        case .context: return MopeliumLocalization.string("Context")
        }
    }
}
...
public struct CoworkProjectInfo: Equatable, Sendable {
    ...
    public init(sessionID: String = "",
                ...
                defaultModel: String = MopeliumLocalization.string("current model"),
                defaultPermission: String = MopeliumLocalization.string("reviewed"),
    ...
    func body(content: Content) -> some View {
        content.accessibilityValue(
            selection.selectedAgentID == agentID
                ? MopeliumLocalization.string("Selected")
                : MopeliumLocalization.string("Not selected"))
    }
}
...
public struct CoworkShell: View {
    ...
    public init(threadPage: CoworkAgentThreadPage,
                ...
                sessionTitle: String = MopeliumLocalization.string("Cowork"),
    ...
    private var threadErrors: [MopeliumThreadErrorEntry] {
        MopeliumThreadErrorPresentation.errors(
    ...
    private func content(outerSize: CGSize) -> some View {
        ...
        let inspectorLayout = MopeliumCoworkStatusRailLayoutPolicy.resolve(
        ...
        let primaryScrollerClearance: CGFloat = inspectorLayout.isVisible
            ? MopeliumCoworkStatusRailLayoutPolicy.scrollerClearance
            : 0
            ...
            .overlay(alignment: .leading) {
                threadColumn(
                    ...
                    inspectorIsAvailable: rawWidth
                        >= MopeliumCoworkStatusRailLayoutPolicy.activationWidth,
    ...
    private func threadColumn(layout: MopeliumThreadContentLayout,
    ...
    private func resolvedHeaderActions(
        ...
        if showsCompactActions {
            if let onShowProjectSettings {
                actions.append(MopeliumThreadHeaderAction(
                    title: MopeliumLocalization.string("Project"),
            ...
            if let onAddAgent {
                actions.append(MopeliumThreadHeaderAction(
                    title: MopeliumLocalization.string("Attach"),
        ...
        let inspectorTitle = permissionPinsInspector
            ? MopeliumLocalization.string("Permission Review")
            : inspectorIsVisible
    ...
    private var inspectorColumn: some View {
        ScrollView {
            ...
            VStack(
                alignment: .leading,
                spacing: MopeliumCoworkStatusRailLayoutPolicy.cardSpacing
            ) {
            ...
            .frame(width: MopeliumCoworkStatusRailLayoutPolicy.cardWidth)
            .padding(
                .leading,
                MopeliumCoworkStatusRailLayoutPolicy.leadingInset)
            .padding(
                .trailing,
                MopeliumCoworkStatusRailLayoutPolicy.trailingInset)
            .padding(.vertical, 16)
        }
    ...
    @ViewBuilder private var permissionStatusSection: some View {
        if let pending {
            PermissionCard(
                ...
                onResolve: onResolve)
                .frame(
                    width: MopeliumCoworkStatusRailLayoutPolicy.cardWidth,
                    alignment: .leading)
                .mopeliumClearLiquidGlass(cornerRadius: 22)
    ...
    private func agentStatusRowContent(_ agent: CoworkAgentInfo) -> some View {
            ...
            if agent.isAttached && agent.inferenceResolution.requiresAttention {
                Image(systemName: "exclamationmark.triangle.fill")
                    ...
                    .accessibilityLabel(agent.inferenceDisplayLabel
                        ?? MopeliumLocalization.string("Inference unavailable"))
            }
        }
        ...
        .help(["\(agent.name): \(mopeliumLocalizedRawStatus(agent.status))", agent.inferenceDisplayLabel]
            .compactMap { $0 }
            .joined(separator: " · "))
    }
            ...
            TimelineView(.periodic(from: .now, by: 1)) { timeline in
                VStack(alignment: .leading, spacing: 9) {
                    ...
                    HStack(alignment: .top, spacing: 12) {
                        goalMetric(
                            MopeliumLocalization.string("Tokens"),
                            value: tokenSummary(for: goal))
                        goalMetric(
                            MopeliumLocalization.string("Run"),
                            value: goal.currentRunOrdinal.map { "#\($0)" }
                                ?? MopeliumLocalization.string("Not started"))
                    }
    ...
    private func goalMetric(_ title: String, value: String) -> some View {
        VStack(alignment: .leading, spacing: 2) {
            Text(MopeliumLocalization.string(title).uppercased())
                .font(.caption.bold())
                .foregroundStyle(threadStyle.tertiaryText)
            Text(value)
                .font(.caption.monospacedDigit())
    ...
    private func tokenSummary(for goal: CoworkGoalCardInfo) -> String {
        ...
        guard let tokenBudget = goal.tokenBudget else {
            return MopeliumLocalization.format("%@ · no budget", used)
        }
    ...
    private func auditSummary(for goal: CoworkGoalCardInfo) -> String? {
        ...
        if let proven = goal.auditProvenCount, let required = goal.auditRequirementCount {
            parts.append(MopeliumLocalization.format(
    ...
    private func displayStatus(_ status: String) -> String {
        mopeliumLocalizedDisplayStatus(status)
    }
    ...
    private func rightRailSection<Content: View>(
        ...
        VStack(alignment: .leading, spacing: 14) {
            Label(MopeliumLocalization.string(title), systemImage: systemImage)
    ...
    @ViewBuilder private var contextInspector: some View {
        ...
        if let latestTurnStats {
            inspectorSection("Last Turn") {
                MopeliumTurnStatsSummaryView(stats: latestTurnStats, style: threadStyle)
            }
        }
    }
        ...
        VStack(alignment: .leading, spacing: 7) {
            inspectorRow(
                ...
                value: project.sessionID.isEmpty
                    ? MopeliumLocalization.string("current")
                    : project.sessionID)
            ...
            ForEach(summary.failedTasks) { task in
                taskCompactRow(
                    ...
                    actionTitle: onRetryTask == nil
                        ? nil
                        : MopeliumLocalization.string("Retry"),
    ...
    private func inspectorRow(_ title: String, value: String) -> some View {
        HStack(alignment: .firstTextBaseline, spacing: 8) {
            Text(MopeliumLocalization.string(title))
                .font(.caption)
                .foregroundStyle(threadStyle.secondaryText)
            Spacer(minLength: 8)
            Text(value)
    ...
    private func statusStrip(layout: MopeliumThreadContentLayout) -> some View {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    HStack(spacing: 5) {
                        Text("@\(agent.name)")
                            ...
                            .foregroundStyle(threadStyle.primaryText)
                            .lineLimit(1)
                        Text(mopeliumLocalizedAgentRole(agent.role))
                            .font(.caption2.bold())
                            .foregroundStyle(threadStyle.secondaryText)
                            .lineLimit(1)
                    }
        ...
        VStack(alignment: .leading, spacing: 7) {
            HStack(alignment: .firstTextBaseline, spacing: 8) {
                Text("@\(agent.name)")
                    ...
                    .lineLimit(1)
                Spacer(minLength: 8)
                Text(mopeliumLocalizedRawStatus(agent.status))
                    .font(.caption2.bold())
                    .foregroundStyle(statusColor(for: agent.status))
                    .lineLimit(1)
            ...
            Text(agent.workspace)
                ...
                .textSelection(.enabled)
            Divider().opacity(0.35)
            agentDetailRow("Role", value: mopeliumLocalizedAgentRole(agent.role))
            ...
            agentDetailRow(
                "Queued",
                value: MopeliumLocalization.format(
    ...
    private func taskCompactRow(task: CoworkTaskLine,
        ...
        VStack(alignment: .leading, spacing: 4) {
            HStack(alignment: .firstTextBaseline, spacing: 6) {
                ...
                Text(mopeliumLocalizedDisplayStatus(task.status))
                    .font(.caption2.bold())
    ...
    private func agentRoster(layout: MopeliumThreadContentLayout) -> some View {
        VStack(alignment: .leading, spacing: 10) {
                    ...
                    LazyHStack(spacing: 8) {
                        if agents.isEmpty {
                            Text("No agents in this session")
                                ...
                                .padding(.horizontal, 12)
                                .padding(.vertical, 9)
                                .mopeliumContentSurface(cornerRadius: 18)
                        }
                        ForEach(agents) { agent in
                            agentPill(agent)
                        }
    ...
    private func agentPill(_ agent: CoworkAgentInfo) -> some View {
        ...
        return Button {
            ...
            .padding(.horizontal, 12)
            .padding(.vertical, 8)
            .mopeliumLiquidGlass(cornerRadius: 18, interactive: true)
        }
        .buttonStyle(.plain)
        .disabled(!agent.isConversationSelectable)
    }
    ...
    @ViewBuilder private func taskHighlights(layout: MopeliumThreadContentLayout) -> some View {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        if showsVisibleThinkingIndicator {
                            MopeliumThreadThinkingRow(
                                ...
                                .id("mopelium-cowork-thinking-\(thinkingPhaseID)")
                        }
                        Color.clear
                            .frame(height: 1)
                            .padding(.bottom, 16)
    ...
    private func resolvedViewportAdmission(
        for pageScope: MopeliumThreadPresentationScope
    ) -> MopeliumMessageViewportAdmission {
    ...
    private var threadHistoryWindow: MopeliumThreadHistoryWindow<CodeItem> {
        MopeliumThreadHistoryWindow(
            items: MopeliumThreadErrorPresentation.transcriptItems(
                threadPage.items),
    ...
    private func composerArea(layout: MopeliumThreadContentLayout) -> some View {
        VStack(alignment: .leading, spacing: 8) {
            MopeliumThreadComposer(
                placeholder: MopeliumLocalization.string("Give Main a project task..."),
                input: $input,
...
private struct CoworkWorkTaskRow: View {
    ...
    private var displayStatus: String {
        mopeliumLocalizedDisplayStatus(task.status)
    }
