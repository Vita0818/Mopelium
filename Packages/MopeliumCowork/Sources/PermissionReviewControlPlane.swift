...
public actor PermissionReviewControlPlane {
    ...
    private static func isHostAgentAdmission(
        ...
        guard task.taskContract?.kind == .agentAdmission,
              ...
              task.gate.policyVersion == "mopelium.workspace-admission.v1",
              task.replayPolicy
              ...
              authorization.registryVersion == "mopelium.cowork.admission.v1",
              authorization.concreteToolID
                == "mopelium.cowork.admission.v1/agent.attach",
    ...
    private static func systemPrompt(reviewer: Agent) -> String {
        """
        You are @\(reviewer.name.rawValue), the dedicated automatic permission reviewer for an Mopelium Cowork session.
