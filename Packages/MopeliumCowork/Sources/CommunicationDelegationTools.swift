...
public struct DelegateTaskTool: Tool {
    ...
    public static let descriptor = ToolDescriptor(
        ...
        description: "Run one ready durable WorkTask by ID. The WorkTask remains the source of truth, "
            ...
            + "Unscoped calls may provide objective instead. 'to' must name an attached agent; if omitted or 'auto', Mopelium selects an available attached worker. "
    ...
    public func execute(_ args: ToolArgs, in context: ToolContext) async throws -> ToolObservation {
        ...
        guard a.workTaskID != nil
            ...
            throw MopeliumError.decoding("delegate_task requires work_task_id or an unscoped objective")
        }
