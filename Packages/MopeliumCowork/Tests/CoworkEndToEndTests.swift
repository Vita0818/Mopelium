...
private func makeCounterFixture() throws -> CounterFixture {
    ...
    let iosSources = root
        .appendingPathComponent("Apps", isDirectory: true)
        .appendingPathComponent("MopeliumiOS", isDirectory: true)
        .appendingPathComponent("Sources", isDirectory: true)
    ...
    return CounterFixture(
        ...
        iOSRoot: root.appendingPathComponent("Apps/MopeliumiOS", isDirectory: true))
}
...
final class CoworkEndToEndTests: XCTestCase {
    ...
    func testMacOSIOSSwiftFileCountScenarioClosesThroughSchedulerAndProjection() async throws {
        ...
        let iOSProvider = E2EProvider(text: "iOS Swift count: 3\nApps/MopeliumiOS/Sources/C.swift\nApps/MopeliumiOS/Sources/D.swift\nApps/MopeliumiOS/Sources/E.swift")
        ...
        let macOSObjective = "Recursively count Swift files in Apps/MopeliumMac only. Do not count iOS files."
        let iOSObjective = "Recursively count Swift files in Apps/MopeliumiOS only. Do not count macOS files."
        ...
        XCTAssertFalse(macOSContract.objective.contains("MopeliumiOS"))
        XCTAssertTrue(iOSContract.objective.contains("MopeliumiOS"))
        XCTAssertFalse(iOSContract.objective.contains("MopeliumMac only"))
