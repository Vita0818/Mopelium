...
private func goalManagerLog() throws -> EventLog {
    let file = FileManager.default.temporaryDirectory
        .appendingPathComponent("mopelium-goal-manager-\(UUID().uuidString)", isDirectory: true)
...
private func goalManagerWorkspace() throws -> URL {
    let url = FileManager.default.temporaryDirectory
        .appendingPathComponent("mopelium-goal-manager-ws-\(UUID().uuidString)", isDirectory: true)
