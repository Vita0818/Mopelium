...
private func workTaskLog() throws -> EventLog {
    let file = FileManager.default.temporaryDirectory
        .appendingPathComponent("mopelium-work-task-\(UUID().uuidString)", isDirectory: true)
...
private func workTaskWorkspace() throws -> URL {
    let url = FileManager.default.temporaryDirectory
        .appendingPathComponent("mopelium-work-task-ws-\(UUID().uuidString)", isDirectory: true)
