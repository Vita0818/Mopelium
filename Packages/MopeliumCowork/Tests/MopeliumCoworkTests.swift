...
private func tempLog() throws -> EventLog {
    let url = FileManager.default.temporaryDirectory
        .appendingPathComponent("mopelium-cowork-\(UUID().uuidString)", isDirectory: true)
...
final class MopeliumCoworkTests: XCTestCase {
    ...
    func testMainCanExplicitlySpawnCoordinatorSubAgent() async throws {
        ...
        XCTAssertTrue(mainSystemPrompt.contains("running inside Mopelium"))
