...
final class MopeliumProvidersTests: XCTestCase {
    func testLegacyProductAdapterNamesCanonicalizeToMopelium() throws {
        XCTAssertEqual(
            ProviderRequestAdapter(rawValue: "intatis:siliconflow-v1"),
            .siliconFlowV1)
        XCTAssertEqual(
            ProviderRequestAdapter(rawValue: "intatis:cohere-v2"),
            .cohereV2)
        XCTAssertEqual(
            ProviderRequestAdapter(rawValue: "intatis:legacy-openai-wire"),
            .legacyOpenAIWire)
        XCTAssertEqual(
            ProviderRequestAdapter(rawValue: "vendor:unknown").rawValue,
            "vendor:unknown")
