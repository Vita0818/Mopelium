...
/// A reference to a secret. Non-environment cases and factories are retained
/// only for decoding legacy wire data. Mopelium's production resolvers normalize
/// or reject them and resolve API keys exclusively from environment variables.
