...
// OpenAICompatibleTranscriber pipeline. Mopelium keeps only the single-model
...
private enum TranscriptionTemporaryFiles {
    static let inputPrefix = "Mopelium-Transcription-Input-"
    static let bodyPrefix = "Mopelium-Transcription-Body-"
...
private struct TranscriptionBodyFile {
    ...
    static func multipart(
        ...
        let boundary = "MopeliumBoundary-\(UUID().uuidString)"
