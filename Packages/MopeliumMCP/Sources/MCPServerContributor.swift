...
/// Provider-neutral proposal source. The only value returned to Mopelium is a
...
public enum MCPServerContributorReviewer {
    ...
    private static func contributorSourceFingerprint(
        ...
        MCPConfigurationCanonical.sha256(Data(
            """
            mopelium.mcp.contributor.v1\u{1f}\(contributorID)\u{1f}\(documentID)\u{1f}\(contentFingerprint)
            """.utf8))
    }
