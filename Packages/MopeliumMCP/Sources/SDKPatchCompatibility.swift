...
/// Audited upstream identity for the only MCP SDK linked by Mopelium.
///
...
/// A feature whose SDK surface must be verified independently from Mopelium's
/// host behavior. `requiresAdapter` means the SDK primitive is usable only
/// behind a reviewed Mopelium lifecycle/policy adapter; `requiresPatch` means
...
public struct MCPSDKCompatibilityEntry: Codable, Equatable, Sendable {
    ...
    public let mopeliumContract: String
    ...
    public init(
        ...
        self.mopeliumContract = mopeliumContract
...
public enum SDKPatchCompatibility {
    ...
    public static let entries: [MCPSDKCompatibilityEntry] = [
        ...
        MCPSDKCompatibilityEntry(
            ...
            mopeliumContract:
                "Mopelium supplies the exact task wire surface, including discriminated CallTool/CreateSamplingMessage/CreateElicitation result unions whose task branch is the exact CreateTaskResult shape; separate remote-server and client-hosted state machines are advertised only for standard-extended after conformance.",
            conformanceTests: [
                "MCPTaskWireTests",
            ...
            upgradeReplay: [
                ...
                "Reconcile upstream wire types without weakening Mopelium durable state machines.",
        ...
        MCPSDKCompatibilityEntry(
            ...
            mopeliumContract:
                "Mopelium owns executable identity, sandbox, environment, process group, bounded framing, stderr diagnostics, cancellation, and TERM/KILL drain.",
            conformanceTests: [
        ...
        MCPSDKCompatibilityEntry(
            ...
            mopeliumContract:
                "Mopelium owns POST/GET/SSE/202/resume/session/404/DELETE, exact origin/trust/proxy/egress, body/frame caps, generation fencing, cancellation, and no replay of side-effecting requests.",
            conformanceTests: [
        ...
        MCPSDKCompatibilityEntry(
            ...
            mopeliumContract:
                "Mopelium owns canonical resource/audience, scope step-up, callback generation, account/authority isolation, durable secret storage, DNS/origin policy, and explicit non-replaying challenge recovery.",
            conformanceTests: [
                "MCPOAuthTests",
        ...
        MCPSDKCompatibilityEntry(
            ...
            mopeliumContract:
                "Mopelium pins its conformance runner and scenario inventory; unknown/unexecuted scenarios fail, and hostile fixtures complement official conformance.",
            conformanceTests: [
    ...
    /// capability shape used by both Mopelium protocol profiles.
