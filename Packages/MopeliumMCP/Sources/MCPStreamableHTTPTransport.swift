...
/// Mopelium-owned implementation of MCP Streamable HTTP 2025-11-25.
///
    ...
    NegotiatedProtocolVersionTransport
{
    ...
    #if canImport(MopeliumCurlTransport)
    ...
    init(
        ...
        self.logger = logger
            ?? Logger(
                label: "mopelium.mcp.http.client",
        ...
        queue.name = "mopelium.mcp.http.url-session"
