...
// 61a44880a85d2fd0d8770908dea5733495e571c8. Mopelium adapts them to its Swift
...
public struct MCPDeferredFunctionSpec:
    ...
    public init(entry: MCPToolBindingEntry) {
        ...
        strict = false
        deferLoading = true
        // Codex strips output_schema from tool_search results. Mopelium keeps
...
public extension MCPToolRegistryBuilder {
    static func buildSearchable(
        ...
        let version = "mopelium.mcp.registry.search.v1." + stableHash([
