...
final class KnowledgeContractTests: XCTestCase {
    ...
    func testStoreSchemaRejectsAdditionalPropertiesAndEscapingSnapshot() throws {
        let validator = KnowledgeJSONSchemaValidator()
        let valid = #"{"schema":"mopelium-rag-store/1","store_id":"kb_demo","revision":1,"current_snapshot":"snap_one","current_snapshot_revision":"sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"}"#
    ...
    func testChunkSchemaValidatesSourceLocatorWithoutExternalResolution() throws {
        ...
        let chunk = """
        {
          ...
          "source_ids":["source-one"],
          "source_locators":[{
            "schema":"mopelium-source-locator/1",
            "source_id":"source-one",
            "source_revision":"\(digest)",
            "adapter_identity":"org.vita.mopelium.utf8-byte-range",
            "adapter_version":"1",
