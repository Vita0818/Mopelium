...
import Crypto
#else
#error("MopeliumKnowledge requires CryptoKit or swift-crypto")
#endif
import MopeliumCore
...
public enum KnowledgeContract {
    ...
    public static let profileSchema = "mopelium-okf-rag-profile/0.1"
    public static let profileIdentity = "org.vita.mopelium.okf-rag"
    public static let profileVersion = "0.1"
    public static let storeSchema = "mopelium-rag-store/1"
    public static let chunkSchema = "mopelium-chunk/1"
    public static let checksumsSchema = "mopelium-rag-checksums/1"
    public static let validationSchema = "mopelium-rag-validation/1"
    public static let evidenceContract = "mopelium-evidence/1"
    public static let validatorIdentity = "org.vita.mopelium.knowledge-validator"
    public static let validatorVersion = "1"
    public static let textNormalizationVersion = "mopelium-text-normalization/1"
    public static let deterministicChunkerIdentity = "org.vita.mopelium.heading-paragraph-window"
    public static let deterministicChunkerVersion = "1"
    public static let exactKNNBackendIdentity = "org.vita.mopelium.exact-knn"
    public static let exactKNNFormatVersion = "float32-json/1"
    public static let exactKNNRuntimeVersion = "1"
    public static let lexicalBackendIdentity = "org.vita.mopelium.bm25"
    ...
    public static let utf8SourceLocatorAdapterIdentity =
        "org.vita.mopelium.utf8-byte-range"
...
public struct KnowledgeSourceLocator: Codable, Equatable, Hashable, Sendable {
    ...
    public init(schema: String = "mopelium-source-locator/1",
                sourceID: String,
...
public struct KnowledgeDenseIndexFile: Codable, Equatable, Sendable {
    ...
    public init(dimensions: Int, vectors: [KnowledgeDenseVectorRecord]) {
        schema = "mopelium-dense-exact-knn/1"
        self.dimensions = dimensions
...
public struct KnowledgeLexicalIndexFile: Codable, Equatable, Sendable {
    ...
    public init(tokenizer: String, documents: [KnowledgeLexicalDocumentRecord]) {
        schema = "mopelium-lexical-bm25/1"
