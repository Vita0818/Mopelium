...
/// Mopelium-native, snapshot-bound RAG entry point. Paths, provider identities,
...
public struct SearchKnowledgeTool: Tool {
    ...
    public static func registryVersionComponent(
        ...
        return try KnowledgeDigest.canonical(Projection(
            version: "mopelium-search-knowledge-registration/1",
            ...
            groundingRevalidationVersion:
                "mopelium-final-grounding-revalidation/1"))
    }
...
struct KnowledgeSearchToolSchemas: Sendable {
    ...
    static func load(
        ...
        if boundToSingleKnowledgeBase {
            ...
            root["$id"] = .string(
                "https://schemas.mopelium.local/knowledge/search-knowledge-bound-input-v2.schema.json")
            root["title"] = .string(
                "Mopelium snapshot-bound search_knowledge input v2")
            input = .object(root)
        }
