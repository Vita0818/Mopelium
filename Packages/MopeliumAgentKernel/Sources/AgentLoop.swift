...
public struct AgentLoop: Sendable {
    ...
    private func runTool(
        ...
        if preparedCall.executableCall == nil,
           ...
           field == AuthorizationSidecarCodec.reservedFieldName {
            ...
            let message =
                "authorization_context_mode_mismatch: __mopelium_authorization_context is host-reserved for Cowork automatic review and is not a business tool argument in this mode"
    ...
    private static func authorizationSidecarFailureMessage(
        ...
        case .valid:
            return nil
        case .missing:
            return "authorization_context_missing: include the required __mopelium_authorization_context string in this exact business tool call"
        case .malformed:
            return "authorization_context_malformed: regenerate this exact business tool call with one nonempty __mopelium_authorization_context string"
