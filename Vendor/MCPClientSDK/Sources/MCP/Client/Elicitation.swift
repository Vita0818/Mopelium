...
public enum CreateElicitation: Method {
    ...
    public enum Parameters: Hashable, Sendable {
        ...
        public struct FormParameters: Hashable, Codable, Sendable {
            ...
            public var task: MCPTaskMetadata?
    ...
    public struct Result: Hashable, Codable, Sendable {
        ...
        /// Present only for the immediate response to a task-augmented
        /// `elicitation/create` request.
        public var task: MCPTaskWire?
        ...
        private enum CodingKeys: String, CodingKey, CaseIterable {
            case action, task, content, _meta
        }
...
extension CreateElicitation.Parameters: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let task = try container.decodeIfPresent(
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .form(let params):
            try container.encodeIfPresent(params.task, forKey: .task)
