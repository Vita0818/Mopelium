...
public struct Tool: Hashable, Codable, Sendable {
    ...
    public struct Execution: Hashable, Codable, Sendable {
        ...
        public let taskSupport: TaskSupport?
    ...
    /// Task-augmentation support for this exact tool.
...
public enum CallTool: Method {
    ...
    public struct Parameters: Hashable, Codable, Sendable {
        ...
        /// Experimental 2025-11-25 task augmentation metadata.
        public let task: MCPTaskMetadata?
    ...
    public struct Result: Hashable, Codable, Sendable {
        /// Present only when this was the immediate response to a
        ...
        private enum CodingKeys: String, CodingKey, CaseIterable {
            case task, content, structuredContent, isError, _meta
        }
        ...
        public init(from decoder: Decoder) throws {
            ...
            _meta = try container.decodeIfPresent(Metadata.self, forKey: ._meta)
            if task == nil, !container.contains(.content) {
                throw DecodingError.keyNotFound(
                    CodingKeys.content,
                    .init(
                        codingPath: container.codingPath,
                        debugDescription:
                            "CallToolResult requires content unless it is a CreateTaskResult"))
            }
        }
    }
}
