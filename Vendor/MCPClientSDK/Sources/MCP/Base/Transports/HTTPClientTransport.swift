...
/// ```
public actor HTTPClientTransport: NegotiatedProtocolVersionTransport {
    ...
    ///   - protocolVersion: A previously negotiated MCP protocol version.
    ///     Defaults to `nil` so initialize is sent without this header.
