...
public enum Initialize: Method {
    ...
    public struct Result: Hashable, Codable, Sendable {
        public let protocolVersion: String
        public let capabilities: RemoteServerCapabilities
        public let serverInfo: RemoteServerInfo
        ...
        public init(from decoder: Decoder) throws {
            ...
            capabilities = try container.decode(
                RemoteServerCapabilities.self,
                forKey: .capabilities
            )
            serverInfo = try container.decode(RemoteServerInfo.self, forKey: .serverInfo)
