...
public struct OAuthConfiguration: Sendable {
    ...
    public enum PrivateKeyJWTAssertionError: LocalizedError, Sendable {
        ...
        public var errorDescription: String? {
            ...
            case .cryptographyUnavailable:
                return "private_key_jwt assertion signing requires CryptoKit or swift-crypto support"
            }
        }
    }
    ...
    /// Only ES256 (P-256 ECDSA) is supported by this helper; the algorithm
    /// requires CryptoKit or the official swift-crypto backend.
    ...
    ///   or ``PrivateKeyJWTAssertionError/cryptographyUnavailable`` when no
    ///   supported cryptography backend is available.
