...
- Reserve the public `@concurrent` transfer boundary for Mopelium's external
...
- Host accepted formulas through a live TextKit 2
  ...
  Mopelium's display revision so an old-size attachment cannot overwrite a
  newer request.
...
- Treat iosMath's eight unmodified OpenType fonts and accompanying math-table,
  ...
  They do not replace or determine Mopelium's product-interface font.
