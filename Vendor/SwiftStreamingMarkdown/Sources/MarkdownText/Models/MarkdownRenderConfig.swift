...
/// Aggregate styling and behavior configuration applied to a `DocumentView`.
///
...
public struct MarkdownRenderConfig: Hashable {
  ...
  public struct MarkdownTableTextStyle: Hashable {
  ...
  public struct MarkdownHeadingTextStyle: Hashable {
  ...
  public struct MarkdownInlineTextStyle: Hashable {
  ...
  public struct CitationConfig: Hashable {
