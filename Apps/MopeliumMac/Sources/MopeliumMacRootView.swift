...
struct MopeliumMacRootView: View {
    ...
    @State private var selection: MopeliumNavItem = .chat
    ...
    private var items: [MopeliumNavItem] {
        MopeliumNavItem.allCases.filter { item in
            switch item {
...
struct MopeliumSidebar: View {
    ...
    private var titleBlock: some View {
        VStack(alignment: .leading, spacing: 2) {
            ...
            Text(MopeliumLocalization.string("Local AI workbench"))
