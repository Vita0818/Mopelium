...
/// inference catalog owned by MopeliumProviders.
///
...
enum AppInferenceCatalogCompiler {
    ...
    static func profileID(providerID: String,
        ...
        let digest = tupleDigest([
            "mopelium.app-inference-profile.v1",
            providerID,
            modelID,
            variantID ?? "",
        ])
    ...
    static func connectionID(providerID: String) -> InferenceConnectionID {
        let digest = tupleDigest([
            "mopelium.app-inference-connection.v1",
            providerID,
        ])
    ...
    static func durableVariantID(providerID: String,
        ...
        let digest = tupleDigest([
            "mopelium.app-inference-variant.v1",
            providerID,
            modelID,
            variantID,
        ])
    ...
    static func trustDomain(providerID: String,
        ...
        let digest = tupleDigest([
            "mopelium.app-inference-trust-domain.v1",
            providerID,
