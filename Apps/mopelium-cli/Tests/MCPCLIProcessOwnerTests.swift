    ...
    XCTestCase
{
        ...
        throws
    {
        ...
        let root = FileManager.default
            .temporaryDirectory
            .appendingPathComponent(
                "mopelium-cli-shipping-stdout-\(UUID().uuidString)",
                isDirectory: true)
        ...
        environment["MOPELIUM_CONFIG"] =
            configURL.path
        environment["MOPELIUM_API_KEY"] =
            "shipping-cli-test-key"
        environment["MOPELIUM_MODEL"] =
            "test/cli-no-mcp-model"
        environment["MOPELIUM_MODE"] = "code"
        environment["MOPELIUM_USAGE"] = "0"
        ...
        async throws
    {
        ...
        let root = FileManager.default
            .temporaryDirectory
            .appendingPathComponent(
                "mopelium-cli-mcp-owner-\(UUID().uuidString)",
                isDirectory: true)
        let workspace = root.appendingPathComponent(
            "workspace",
            isDirectory: true)
    ...
    private static func makeHostFixture(
        ...
        let root = FileManager.default
            .temporaryDirectory
            .appendingPathComponent(
                "mopelium-cli-host-\(name)-\(UUID().uuidString)",
                isDirectory: true)
        let workspace = root.appendingPathComponent(
            "workspace",
            isDirectory: true)
        ...
        throws -> URL
    {
        ...
        throw XCTSkip(
            "The built shipping mopelium executable is unavailable.")
    }
}
...
private final class MCPCLILoopbackFixture {
    ...
    init() throws {
        statsURL = FileManager.default
            .temporaryDirectory
            .appendingPathComponent(
                "mopelium-cli-mcp-stats-\(UUID().uuidString).log")
